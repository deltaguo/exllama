...
#include "hip_func/rms_norm.cuh"
#include "hip_func/rope.cuh"
#include "hip_func/half_matmul.cuh"

#include "hip_func/q4_attn.cuh"
#include "hip_func/q4_mlp.cuh"
...
)
{
    ...
    hipStream_t current_stream = at::hip::getCurrentHIPStreamMasqueradingAsCUDA().stream();
...
)
{
    ...
    const at::hip::OptionalHIPGuardMasqueradingAsCUDA device_guard(x.device());
